...
|---|---|---|---|---|
| 73 | **DirectNet** (production) | [`DirectNet-L73-accuracy.md`](DirectNet-L73-accuracy.md) | `crit30f@large`, 0.92 M | **14/16** |
| 74 | **BSIM-AR Transformer** (higher-fidelity) | [`BSIM-AR-L74-accuracy.md`](BSIM-AR-L74-accuracy.md) | `corroft@medium`, 1.9 M | **15/16** |
| 75 | **PFN / TabPFN** (research) | [`PFN-L75-accuracy.md`](PFN-L75-accuracy.md) | `clean@small`, 0.69 M | 11/16, **zero OMP flips** |
