...
> circuit totals are **/20**, device AC **/10** and opamp AC **/5**. Every
...
they agree on **15/16 circuit verdicts**; the sole split is the `large` SRAM
...
Switchcap is the strongest circuit class at 15/20; SRAM is 8/20. The expanded
