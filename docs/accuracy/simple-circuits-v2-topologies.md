...
| `self_biased_cascode_pmos` | PMOS compliance DC | the polarity complement: a passive load line and two diode-connected PMOS devices generate both cascode rails |
