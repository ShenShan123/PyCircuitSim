...
- **Success (as planned) =** headline **>11/16** AND **force_ic 8/8**, no protected gate regressed, every killed arm recorded. **Achieved (2026-06-16): headline 13/16** (net +2 vs the S8 11/16 baseline — tsmc7 ring_osc + tsmc16 switchcap) **— `>11/16` MET; force_ic 8/8 — NOT met (0/8, verified on both changed techs).** The S12-claimed +3 (14/16) was corrected to +2 at S19: the tsmc16 opamp flip was a non-reproducible scorer fluke (retracted — see "S19 outcomes"/`S19_promotion.md`). S11/S11b/S19 establish the residual gaps are model-fidelity limits, so the honest ship is **13/16 with force_ic + tsmc5 SC + tsmc7 opamp + tsmc16 opamp as documented known-issues**; closing them needs a structural change, out of the cheap-lever scope. Promotion is on the circuit gates (16 cells + force_ic + inverter); derivative fidelity is reported, not promoted on (rev-4 ruling 6 — it anti-correlates with the value-owned opamp/RO).
