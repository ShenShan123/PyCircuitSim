...
**Date:** 2026-06-01  •  **Status:** Phase 0 COMPLETE (6/6) — RO Phase-2 lever DEAD-on-arrival, SRAM Phase-1 viable; SRAM-only path (target 10/16, RO → V6.4.7), 2026-06-01  •  **Branch:** `feat/v6.4.6` (cut from `feat/v6.4.4` @ `54c4759`)
...
2. Along the TSMC7 RO trip, does **post-Rule-15 autograd gds/Cgd already track analytic OSDI within ~10 %**? If yes, the 4.2 ps is in `qs`/BDF-2 — *which* solver-side lever then? (No phase currently scopes a BDF-2/`qs` fix.)
