# BSIM-CMG Python interface and verification instructions
...
Source technology cards are owned by project-root `PDKs/` (tracked ASAP7,
private TSMC). This compact-model tree owns evaluator source and generated
artifacts only.
...
* **Update AGENTS.md:**
    * After every correction, update AGENTS.md so the same mistake is not repeated.
* **Never be lazy:**
