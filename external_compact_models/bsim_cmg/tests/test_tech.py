...
PDKS_DIR = ROOT.parents[1] / "PDKs"
ASAP7_MODELCARD = PDKS_DIR / "ASAP7" / "7nm_TT_160803.pm"
...
@pytest.mark.skipif(
    not (PDKS_DIR / "TSMC7" / "cln7_1d8_sp_v1d2_2p2.l").exists(),
...
@pytest.mark.skipif(
    not (PDKS_DIR / "TSMC6" / "cln6_1d8_sp_v1d0_2p2.l").exists(),
...
@pytest.mark.skipif(
    not (PDKS_DIR / "TSMC5" / "cln5_1d2_sp_v1d2_2p2.l").exists(),
