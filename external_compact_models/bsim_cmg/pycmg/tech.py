...
# Repository and compact-model roots have different ownership: source PDKs
# live at repository root while generated cards remain local to this model.
_BSIM_CMG_ROOT = Path(__file__).resolve().parents[1]
...
_ASAP7_MODELCARD = "PDKs/ASAP7/7nm_TT_160803.pm"
...
TECH_REGISTRY: Dict[str, TechConfig] = {
    ...
    "TSMC5": TechConfig(
        ...
        pdk_path="PDKs/TSMC5/cln5_1d2_sp_v1d2_2p2.l",
    ),
    "TSMC6": TechConfig(
        name="TSMC6",
        vdd=0.75,
        ...
        pdk_path="PDKs/TSMC6/cln6_1d8_sp_v1d0_2p2.l",
    ),
    "TSMC7": TechConfig(
        name="TSMC7",
        vdd=0.75,
        tfin=6e-9,
        devices=_tsmc_devices(["svt", "lvt", "ulvt"], tfin=6e-9),
        pdk_path="PDKs/TSMC7/cln7_1d8_sp_v1d2_2p2.l",
    ),
    "TSMC12": TechConfig(
        name="TSMC12",
        vdd=0.80,
        ...
        pdk_path="PDKs/TSMC12/cln12ffcll_1d8_sp_v1d0_2p4.l",
    ),
    "TSMC16": TechConfig(
        name="TSMC16",
        vdd=0.80,
        ...
        pdk_path="PDKs/TSMC16/crn16ffcll_1d8_sp_v1d0_2p1.l",
    ),
}
...
def resolve_modelcard(
    ...
    Args:
        ...
        cache_dir: Directory for cached generated modelcards, resolved
            relative to the BSIM-CMG model root. Defaults to
            ``"build/modelcards"``.
    ...
    if device.pdk_device is not None:
        ...
        # Generated cards belong to the compact-model build tree, not PDKs/.
        cache_path = Path(cache_dir)
        cache_root = (cache_path if cache_path.is_absolute()
                      else _BSIM_CMG_ROOT / cache_path)
