...
Usage:
    # From external_compact_models/bsim_cmg/
    python scripts/generate_naive_tsmc.py \
        --tech TSMC7 \
        --pdk ../../PDKs/TSMC7/cln7_1d8_sp_v1d2_2p2.l \
        --output build/modelcards/TSMC7/ \
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Run from external_compact_models/bsim_cmg/.
  ...
  python scripts/generate_naive_tsmc.py \\
      --tech TSMC5 \\
      --pdk ../../PDKs/TSMC5/cln5_1d2_sp_v1d2_2p2.l \\
      --output build/modelcards/TSMC5/ \\
