...
Usage:
    NGSPICE_BIN=$PWD/tools/ngspice-45.2/bin/ngspice \
      conda run -n pycircuitsim python tests/diag_l72_complex_control.py \
...
def ring(bt: BenchTech) -> Dict:
    ...
    from tests.verify_complex_ring_osc import run_ngspice_ro
...
def opamp(bt: BenchTech) -> Dict:
    ...
    from tests.verify_complex_opamp import run_ngspice_opamp, _bias, _gain_trip
